...
CREATE TABLE pri1 (LIKE pre3 INCLUDING ALL);
CREATE TABLE pri2 (LIKE pre3 INCLUDING ALL);
CREATE TABLE pri3 (LIKE pre3 INCLUDING ALL);
CREATE TABLE pri4 (LIKE pre3 INCLUDING ALL);
CREATE TABLE pri5 (LIKE pre3 INCLUDING ALL);
CREATE TABLE pri6 (LIKE pre3 INCLUDING ALL);
CREATE TABLE sec1 (LIKE pre3 INCLUDING ALL);
CREATE TABLE sec2 (LIKE pre3 INCLUDING ALL);
CREATE TABLE sec3 (LIKE pre3 INCLUDING ALL);
